      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
              <li class="nav-item active">
                <a class="nav-link" href="/simpleuserr">Home <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/ff">listeService</a>
              </li>
              
              <li class="nav-item">
                <a class="nav-link" href="/step1">passer Demande</a>
              </li>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-info" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="/mesdemandepayer">mes Demandes payer</a>
                  <a class="dropdown-item" href="/mesDemandes">toute mes Demandes</a>
